...
window.addEventListener('load', () => {
    Swal.fire({
        title: 'Bạn muốn nghe nhạc không?',
        icon: 'warning',
...
const animationTimeline = () => {
    ...
    tl.to(".container", 0.6, { visibility: "visible" })
        ...
        // 🎈 Bóng bay và vòng tròn chạy đồng thời
        .staggerFromTo(".baloons img", 2.5,
            { opacity: 0.9, y: 1400 },
            { opacity: 1, y: -1000 },
            0.2,
            "party" // label cho chạy cùng nhau
        )
        ...
        .staggerFromTo(
            ...
            .to(".wish", 1, {}, "+=5") // chờ thêm 3 giây trước khi tiếp tục
    ...
    0.25,
    "-=0.5" // đồng bộ thời gian với phần bánh
)

        // 💫 Vòng tròn nổ chạy song song với bóng bay
